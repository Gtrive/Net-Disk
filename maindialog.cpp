    ...
    , ui(new Ui::MainDialog)
{
    ...
    /////////菜单//////////
    //1.定义菜单项 ":/"对应资源文件路径
    QAction * action_addFolder = new QAction( QIcon(":/images/folder.png"),  "新建文件夹",this);
    QAction * action_uploadFile = new QAction( QIcon(":/images/file.png"),  "上传文件",this);
    QAction * action_uploadFolder = new QAction( QIcon(":/images/folder.png"),  "上传文件夹",this);
    //2.添加菜单项
    ...
    QAction * action_downloadFile = new QAction("下载文件",this);
    QAction * action_share = new QAction("分享文件",this);
    QAction * action_delete = new QAction("删除文件",this);
    QAction * action_getshare = new QAction("获取分享",this);//分享到本地目录
